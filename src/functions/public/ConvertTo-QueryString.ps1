function ConvertTo-QueryString {
    ...
    .EXAMPLE
        @{ taco = 12;burrito = 8;quesadilla = 6 } | ConvertTo-QueryString

        taco=12&quesadilla=6&burrito=8

    .EXAMPLE
        @{ state = 'OPEN' },@{ state = 'MERGED' } | ConvertTo-QueryString
    ...
    .EXAMPLE
        ...
        ConvertTo-QueryString -InputObject $nvCollection
    ...
    .EXAMPLE
        ...
        # are piped to ConvertTo-QueryString which will output $null as a result.
        ,$nvCollection | ConvertTo-QueryString
